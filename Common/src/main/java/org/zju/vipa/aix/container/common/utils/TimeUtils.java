...
//    }
     ...
     * @since 1.0
     */
    public static String getInterval(long milliseconds) {
        ...
        while (seconds >= 1L) {
            if (seconds < SECONDS_PER_MINUTE) {
                ...
                buffer.append(seconds / SECONDS_PER_MINUTE).append("min ");
                seconds%=SECONDS_PER_MINUTE;
            } else if (seconds < SECONDS_PER_DAY) {
                buffer.append(seconds / SECONDS_PER_HOUR).append("hour ");
                seconds%=SECONDS_PER_HOUR;
            } else if (seconds < SECONDS_PER_MONTH) {
                buffer.append(seconds / SECONDS_PER_DAY).append("day ");
                seconds%=SECONDS_PER_DAY;
            } else if (seconds < SECONDS_PER_YEAR) {
                buffer.append(seconds / SECONDS_PER_MONTH).append("month ");
                seconds%=SECONDS_PER_MONTH;
            } else {
                buffer.append(seconds / SECONDS_PER_YEAR).append("year ");
                seconds%=SECONDS_PER_YEAR;
            }
        }
        int ms= (int) (milliseconds % 1000);
        if (ms!=0) {
            buffer.append(ms).append("ms");
        }
