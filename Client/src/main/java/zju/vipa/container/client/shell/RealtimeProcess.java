...
//        mProcessBuilder.directory(new File(System.getenv("HOME")));
        ...
        //todo 0221改运行环境env?   INFO:ShellTask: source /root/miniconda3/bin/activate pip-env  execDir: /
        //DEBUG:Client received:
        //java.io.IOException at java.lang.ProcessBuilder.start  line 1048    19-Feb-2020 15:12:20:430:
        //Cannot run program "source" (in directory "/"): error=2, No such file or directory

//        mProcessBuilder.command(mRealtimeProcessCommand.getCmdWords().split("\\s"));
//        mProcessBuilder.command(partitionCommandLine(mRealtimeProcessCommand.getCmdWords()));
