...
//    }
    ...
    public static void debug(Action action, String msg, Object... objs) {
        logger.debug(action + msg, objs);
    }
    ...
    public static void info(Action action, String msg, Object... objs) {
        logger.info(action + msg, objs);
    }
...
//    }
    ...
    public static void worning(Action action, String msg, Object... objs) {
        logger.warn(action + msg, objs);
    }
...
//    }
    ...
    public static void error(Action action, String msg, Object... objs) {
        logger.error(action + msg, objs);
    }
